...
public class CommandGenerate extends BaseCommand
{
  ...
  public boolean run(CommandSender sender, String[] args)
  {
    ...
    if (args.length == 0)
    {
      List<GlyphGenerator> generators = Inscription.getInstance().getLootHandler().getGenerators();
    ...
    else if (args.length == 1)
    {
      ...
      GlyphGenerator generator = Inscription.getInstance().getLootHandler().getGenerator(generatorType);
      if (generator == null)
      {
