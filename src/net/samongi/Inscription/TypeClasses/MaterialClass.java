...
public class MaterialClass implements Serializable
{
   ...
   * 
   * @param type
   *          The type of the material to check
   * @return True if the class contains the material type
   */
  public boolean containsMaterial(Material type)
  {
   ...
   * @param class_name
   */
  public void addInheritied(String class_name)
  {
  ...
  public static MaterialClass parse(ConfigurationSection section)
  {
    ...
    if (materials != null) Inscription.logger.fine("Found Materials:");
    ...
    if (inherited != null) Inscription.logger.fine("Found Inherited:");
