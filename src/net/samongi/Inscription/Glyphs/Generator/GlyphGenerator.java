...
public class GlyphGenerator
{
   ...
   * 
   * @param type_name
   *          This will be upcased and underscored spaced.
   */
  ...
  {
    return this.getGlyph(min_level, max_level);
  }
  ...
  public static GlyphGenerator parse(ConfigurationSection section)
  {
    ...
    Inscription.logger.fine("Found type_name to be: '" + type_name + "'");
    ...
    Inscription.logger.fine("Found min_level to be: '" + min_level + "'");
    Inscription.logger.fine("Found max_level to be: '" + max_level + "'");
    ...
    for (String k : element_keys)
    {
      ...
      Inscription.logger.fine("  Found e to be: '" + e + "'");
